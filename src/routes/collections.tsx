  ...
  head: () => ({
    meta: [
      { title: "Collections — QISSA Leather Outerwear" },
      {
        name: "description",
        content:
          "Browse the QISSA collection: leather outerwear, shearling and quilted pieces made in limited numbers by our atelier.",
      },
      { property: "og:title", content: "Collections — QISSA" },
      {
        property: "og:description",
        content: "Leather outerwear made in limited numbers. Wear Your Story.",
      },
...
const pieces = [
  ...
  { img: rel1, name: "Notte Bomber", cat: "Outerwear", price: "₹ 42,000" },
  { img: rel2, name: "Strada Blouson", cat: "Outerwear", price: "₹ 39,500" },
  { img: rel3, name: "Alba Shearling", cat: "Shearling", price: "₹ 68,000" },
  { img: rel4, name: "Riposo Quilted", cat: "Quilted", price: "₹ 44,000" },
  { img: gallery2, name: "Sera Moto", cat: "Outerwear", price: "₹ 52,000" },
  { img: lifeNight, name: "Mezzanotte Coat", cat: "Archive", price: "₹ 74,000" },
  { img: lifeCity, name: "Corso Overshirt", cat: "Archive", price: "₹ 28,000" },
];
        ...
        <section className="pt-40 md:pt-56">
          <div className="shell">
            <p data-reveal className="reveal eyebrow">
              Autumn / Winter — Chapter II
            </p>
            <h1 data-reveal className="reveal display mt-8 text-[2.8rem] md:text-[5rem]">
              The Collection
            </h1>
            <p
              data-reveal
              className="reveal mt-12 max-w-[52ch] leading-[2] text-muted-foreground"
            >
              Eight pieces, cut from a single idea: outerwear that carries a life in it. Each
              garment is produced in a limited run and finished by hand in our atelier.
            </p>
          </div>
        </section>
              ...
              {filters.map((f, i) => (
                <button
                  ...
                  className={`eyebrow transition-colors duration-500 ${
                    i === 0 ? "!text-foreground" : "hover:!text-foreground"
                  }`}
                >
                  {f}
                </button>
        ...
        <section className="mt-40 md:mt-64">
          <div className="shell grid items-center gap-16 lg:grid-cols-2">
            <div data-reveal className="reveal zoom-frame bg-secondary">
              <img
                src={fit}
                alt="Model wearing a QISSA leather jacket, full length"
                loading="lazy"
                width={1200}
                height={1500}
            ...
            <div data-reveal className="reveal">
              ...
              <p className="mt-10 max-w-[42ch] leading-[2] text-muted-foreground">
                Our atelier receives a small number of guests each week for fittings, alterations
                and archive viewings.
              </p>
              <button className="lift eyebrow mt-14 bg-foreground px-10 py-5 !text-primary-foreground hover:bg-accent">
                Book an Appointment
              </button>
            </div>
          </div>
