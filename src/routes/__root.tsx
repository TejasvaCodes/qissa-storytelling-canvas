...
import brandCss from "../brand-logo.css?url";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "QISSA crafts leather outerwear made to be lived in. Wear Your Story." },
      { name: "author", content: "QISSA" },
      { property: "og:title", content: "QISSA — Wear Your Story." },
      { property: "og:description", content: "QISSA crafts leather outerwear made to be lived in. Wear Your Story." },
    ...
    links: [
      ...
      { rel: "icon", href: "/qissa-mark.svg", type: "image/svg+xml" },
    ],
  }),
